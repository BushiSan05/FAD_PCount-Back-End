...
<a href="<?= base_url('csvmonitor/menu') ?>" class="back-btn">
    ← Back to Menu
</a>
...
<table>
    ...
    <?php else: ?>
        ...
        <tr>
            ...
            <td>
                <a href="<?= site_url('csvmonitor/viewNfCsv/' . rawurlencode($fileName)) ?>">
                    View Contents
                </a>
                |
                <a href="<?= base_url('nfitems/' . rawurlencode($fileName)); ?>" target="_blank">
                    Download
                </a>
            </td>
        </tr>
